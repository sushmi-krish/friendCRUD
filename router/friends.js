  ...
  if(friend){
    ...
    if(DOB){
     ...
     friends[email] = friend;
       res.send(`Friend with the email ${email}`)
  }else{
  res.send("unable to find the friend!")//This line is to be replaced with actual return value
  }
});
...
router.delete("/:email", (req, res) => {
  ...
  res.send("Friends with the email"+email+"deleted.")//This line is to be replaced with actual return value
});
